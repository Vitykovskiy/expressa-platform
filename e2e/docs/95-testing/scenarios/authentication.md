...
1. Customer видит ограничение повторной отправки одноразового кода.

## Ожидаемый результат

- Customer видит время до повторной отправки кода, а кнопка повторной отправки недоступна.
