 ...
 * 2. Администратор раскрывает категорию «Выпечка».
 * 3. Администратор открывает редактирование товара «Круассан».
 * 4. Администратор запрашивает удаление товара «Круассан».
 * 5. Администратор отменяет удаление товара «Круассан».
 * 6. Администратор повторно запрашивает удаление товара «Круассан».
 * 7. Администратор подтверждает удаление товара «Круассан».
 *
 * Ожидаемый результат:
...
test("CATALOG-12: администратор архивирует товар", async ({
  ...
  await menuManagement.catalog.expandCategory("Выпечка");
