...
report_root="${E2E_REPORT_ROOT:-/srv/expressa/development/e2e-reports}"
report_config_root="${E2E_REPORT_CONFIG_ROOT:-/srv/expressa/development/e2e-report-host}"
report_port="${E2E_REPORT_PORT:-8088}"
runtime_file="${E2E_RUNTIME_FILE:-/srv/expressa/development/runtime.env}"
work_root="${E2E_WORK_ROOT:-/srv/expressa/e2e-runs}"
