...
| [BL-0068.md](front-office/BL-0068.md) | complete | [Состояние сессии](../../../../front-office/src/app/session.store.spec.ts)  |
...
| Карточка                             | Статус   | Доказательство                                                            |
| ------------------------------------ | -------- | ------------------------------------------------------------------------- |
| [BL-0071.md](back-office/BL-0071.md) | complete | [Router role policy](../../../../back-office/src/app/router.spec.ts)      |
...
| Карточка                         | Статус   | Доказательство                                                                        |
| -------------------------------- | -------- | ------------------------------------------------------------------------------------- |
| [BL-0074.md](quality/BL-0074.md) | complete | [Ручная приёмка пользовательских потоков](../../../95-testing/Mandatory-scenarios.md) |
