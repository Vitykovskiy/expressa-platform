...
Гость открывает front-office, получает `GET /api/v3/public/menu`, выбирает
...
на `POST /api/v3/orders`. [Cart/checkout](../../front-office/docs/30-features/Cart-and-checkout.md),
