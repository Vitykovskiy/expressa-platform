...
Отдельный E2E-пакет не входит в структуру репозитория: автоматизированные сквозные сценарии удалены, пока продукт активно меняется. Для проверок используются тесты, принадлежащие соответствующим приложениям, и ручная приёмка работающего UI при необходимости.
