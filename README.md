...
Система объединяет два веб-приложения и общий HTTP API. Подробный продуктовый сценарий описан в
...
## Границы проверки и данных

Отдельного E2E-набора и E2E-gate нет; пользовательские сценарии принимаются
вручную в работающем приложении. Базы local/test/development одноразовые: они
пересоздаются из текущей схемы и детерминированного seed при поддерживаемом
запуске. История миграций, backfill и сохранение данных не поддерживаются.
Staging и production до отдельного архитектурного решения не поддерживаются.
