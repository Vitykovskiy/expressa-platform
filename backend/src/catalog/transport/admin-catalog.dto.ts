...
export class AdminCatalogModifierGroupDto {
  ...
  selectionType!: AdminCatalogModifierSelectionType;
...
export class AdminCatalogDto {
  @ApiProperty({ isArray: true, type: () => AdminCatalogCategoryDto })
  categories!: AdminCatalogCategoryDto[];
  @ApiProperty({ isArray: true, type: () => AdminCatalogProductDto })
  products!: AdminCatalogProductDto[];
  @ApiProperty({ isArray: true, type: () => AdminCatalogProductVariantDto })
  productVariants!: AdminCatalogProductVariantDto[];
  @ApiProperty({ isArray: true, type: () => AdminCatalogModifierGroupDto })
  modifierGroups!: AdminCatalogModifierGroupDto[];
  @ApiProperty({ isArray: true, type: () => AdminCatalogModifierOptionDto })
  modifierOptions!: AdminCatalogModifierOptionDto[];
  @ApiProperty({
    isArray: true,
    type: () => AdminCatalogCategoryModifierGroupDto,
  })
  categoryModifierGroups!: AdminCatalogCategoryModifierGroupDto[];
}
