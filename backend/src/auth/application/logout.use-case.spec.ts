...
import type { AuthRepository, AuthSession, SessionLogout } from './auth-repository.types';
...
describe('LogoutUseCase', () => {
  it('отзывает известную сессию по refresh token', async () => {
    ...
    await expect(useCase.execute(`${sessionId}.${refreshSecret}`)).resolves.toBeUndefined();
