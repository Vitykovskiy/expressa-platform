...
export type OrderNotificationCommand =
  | { recipient: 'staff'; orderId: string; number: string; stage: 'CREATED'; customerId: string }
  | { recipient: 'customer'; orderId: string; number: string; stage: 'ACCEPTED' | 'READY' | 'ISSUED'; customerId: string };
