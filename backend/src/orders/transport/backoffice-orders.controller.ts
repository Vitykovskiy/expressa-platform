...
function toListDto(order: OrderQueueItem): BackofficeOrderListItemDto { return { id: order.id, number: order.number, createdAt: order.createdAt.toISOString(), total: order.total, stage: order.stage }; }
