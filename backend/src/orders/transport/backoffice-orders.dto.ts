...
import type { BackofficeOrderDetailsDto, BackofficeOrderEventDto, BackofficeOrderListItemDto } from './backoffice-orders.dto.types';
...
export class BackofficeOrderDetailsResponseDto extends BackofficeOrderListItemResponseDto implements BackofficeOrderDetailsDto {
  @ApiProperty({ type: () => BackofficeOrderCustomerResponseDto }) customer!: BackofficeOrderCustomerResponseDto;
  @ApiProperty({ isArray: true, type: () => OrderItemResponseDto }) snapshot!: OrderItemResponseDto[];
  @ApiProperty({ isArray: true, type: () => BackofficeOrderEventResponseDto }) events!: BackofficeOrderEventResponseDto[];
}
