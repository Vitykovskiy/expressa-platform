...
export type BackofficeOrderEventDto = { actorId: string; actorLabel: string; occurredAt: string; from: OrderStage; to: OrderStage };
export type BackofficeOrderListItemDto = { id: string; number: string; createdAt: string; total: number; stage: OrderStage };
