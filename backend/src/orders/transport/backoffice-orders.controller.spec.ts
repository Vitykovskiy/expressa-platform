...
describe('BackofficeOrdersController', () => {
  it('отдаёт staff-очередь и детали в каноническом DTO', async () => {
    ...
    await expect(controller.list('CREATED', '001')).resolves.toEqual([{ id: orderId, number: '20300102-001', createdAt: '2030-01-02T03:04:05.000Z', total: 450, stage: 'CREATED' }]);
