...
«Введите номер телефона». Обычный вход поясняет «Он нужен для оформления заказа
и просмотра истории.», вход из checkout — «Чтобы оформить заказ.», из history —
«Чтобы посмотреть историю заказов.»; видимого label нет, но программное имя
...
«Введите код», пояснение — «Отправили его на {phone}.». Видимого label и
видимой подсказки о шести цифрах нет; программное имя «Шестизначный код из
