...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/auth/phone', component: AuthPhonePage, meta: { title: 'Вход по телефону' } },
    { path: '/auth/code', component: AuthCodePage, meta: { title: 'Подтверждение кода' } },
    { path: '/orders/:id', component: OrderPage, meta: { title: 'Заказ' } },
    { path: '/orders', component: OrdersPage, meta: { title: 'История заказов' } },
  ],
})
