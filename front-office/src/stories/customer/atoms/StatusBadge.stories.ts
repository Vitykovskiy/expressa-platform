...
import UiBadge from "../../../customer/shared/ui/badge/UiBadge.vue";
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Краткая статусная метка. Контракт: tone и default slot. Используйте для понятного текста состояния, не полагайтесь только на цвет. Источник: src/customer/shared/ui/badge/UiBadge.vue.",
      },
    },
  },
  render: (args) => ({
