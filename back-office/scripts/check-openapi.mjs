...
const backendContract = new URL('../../backend/openapi/openapi.json', import.meta.url)
...
if (!backendContents.equals(snapshotContents)) {
  process.stderr.write('OpenAPI-снимок back-office не совпадает с backend/openapi/openapi.json.\n')
  process.exitCode = 1
}
